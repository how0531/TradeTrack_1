...
export const I18N = {
    zh: {
        ...
        syncing: '同步中...', synced: '已同步', offline: '離線', saving: '儲存中...', saved: '已儲存', syncError: '同步失敗', retry: '重試',
    ...
    en: {
        ...
        syncing: 'Syncing...', synced: 'Synced', offline: 'Offline Mode', saving: 'Saving...', saved: 'Saved', syncError: 'Sync Error', retry: 'Retry',
